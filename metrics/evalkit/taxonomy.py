...
STAGE_RX = {
  ...
  'bravo': {
    'greeting': '^🤖 \\*\\*Assistant\\*\\* _\\(greeting\\)_:\\n> (?:How can I help you today\\?|Hi there! I will be your virtual assistant)',
    'customer_intent': '(?im)^🧑 \\*\\*Customer\\*\\*(?: _\\([^)]*\\)_)?:\\n> .*\\b(?:claim|compensation|owed|delayed)\\b',
    ...
    'otp_channel_selection': 'send(?:ing)? (?:you )?a one-time verification code',
